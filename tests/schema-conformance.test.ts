...
describe('MCP 2026-07-28 — structuredContent conforms to outputSchema (SDK 2020-12 validator)', () => {
    ...
    const cases: Array<[string, () => Record<string, unknown>]> = [
        ...
        ['inspect_pdf', () => ({ pdfBase64: form, annotations: true, check: ['annotations'] })],
        ['inspect_pdf', () => ({ pdfBase64: form, annotations: true, verbosity: 'summary' })],
        ['inspect_pdf', () => ({ pdfBase64: plain, annotations: true, fields: ['annotationCount', 'annotations'] })],
        ...
        ['inspect_layout', () => ({ title: 'L', blocks: [{ type: 'heading', text: 'H', level: 1 }, { type: 'pageBreak' }, { type: 'table', headers: ['a', 'b'], rows: [['1', '2']] }] })],
        ['inspect_layout', () => ({ title: 'L', blocks: [{ type: 'paragraph', text: 'x' }], verbosity: 'summary' })],
        ['inspect_layout', () => ({ title: 'L', blocks: [{ type: 'paragraph', text: 'x' }], fields: ['totalPages', 'pages.blocks.height'] })],
