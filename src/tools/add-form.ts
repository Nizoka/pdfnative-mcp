...
export async function addForm(rawInput: unknown): Promise<OutputResult> {
    ...
    const { title, fields, footerText, pdfA, print, outputIntent, metadata, creationDate, pageSize, margins, headerTemplate, footerTemplate, typography, compress, debug, encrypt, strict, includeDiagnostics, embedFonts, outputMode, outputPath } = parsed.data;
