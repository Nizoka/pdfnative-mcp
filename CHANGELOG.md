...
- **test:** offline mock PKI (`tests/_ltv-fixtures.ts`), loopback RFC 3161 server (`tests/_tsa-server.ts`), in-memory MCP harness (`tests/_mcp-harness.ts`), HTTP fixture; 647 tests across 54 files; coverage thresholds raised to 89 / 80 / 90 / 91.
